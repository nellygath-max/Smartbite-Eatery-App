...
export default function HeroBanner() {
  return (
    <section className="hero-banner overflow-hidden bg-emerald-800 text-white">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-18 md:grid-cols-2 md:py-24">
        <div className="hero-copy">
          ...
          <h1 className="mt-5 max-w-xl text-5xl font-black leading-[1.03] tracking-tight md:text-7xl">
            Good food for your{' '}
            <span className="text-orange-300">good days.</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              to="/menu"
              className="rounded-2xl bg-orange-500 px-6 py-3.5 font-extrabold text-white shadow-lg shadow-orange-950/20 transition hover:bg-orange-400"
            >
              Explore the menu
            </Link>
            <Link
        ...
        <div className="hero-artwork relative mx-auto grid h-80 w-full max-w-md place-items-center md:h-96">
          <div className="hero-orb absolute h-64 w-64 rounded-full bg-orange-400/30 blur-3xl" />
          <img
            className="hero-image relative h-72 max-w-full object-contain drop-shadow-2xl md:h-96"
            src={heroArtwork}
            alt="SmartBite ordering experience"
          />
          <div className="hero-rating absolute -bottom-2 -left-3 rounded-2xl bg-white p-4 text-stone-900 shadow-xl">
            <b className="text-orange-500">★ 4.9</b>
            <span className="ml-2 text-sm text-stone-500">Loved locally</span>
          </div>
        </div>
      </div>
    </section>
